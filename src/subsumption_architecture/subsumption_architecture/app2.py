...
sys.path.append(os.path.join(os.path.dirname("/home/tnoin/codes/hand/ros_hand/src/hand/hand/")))
...
class ImageSubscriber(Node):
    def __init__(self):
        ...
        with open('/home/tnoin/codes/hand/ros_hand/src/hand/hand/model/keypoint_classifier/keypoint_classifier_label.csv',
        ...
        with open(
            '/home/tnoin/codes/hand/ros_hand/src/hand/hand/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
...
def main(args = None):
    ...
    image_subscriber.destoroy_node()
    rclpy.shutdown()
